...
public class Enemy_Combat : MonoBehaviour
{
    ...
    public bool Eye, Samurai, Wizard;
    AIPath aipath;
    ...
    void Die()
    {
        ...
        score.SetTextValue();
        score2.SetTextValue();
        if (Eye == true) FindObjectOfType<AudioManager>().Play("EyeDeath");
        if (Wizard == true) FindObjectOfType<AudioManager>().Play("WizardDeath");
        if (Samurai == true) FindObjectOfType<AudioManager>().Play("WizardDeath");
